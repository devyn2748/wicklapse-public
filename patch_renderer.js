...
// We will use replace with string markers.
const backgroundStartMarker = 'function drawBackground(';
const backgroundEndMarker = 'function candleIntervalLabel(';

const landscapeStartMarker = 'function drawLandscapeReplayFrame(';
const landscapeEndMarker = 'export function drawReplayFrame(';

const replayStartMarker = 'export function drawReplayFrame(';

// Prepare the new code blocks.
const newBackground = `
...
function drawBackground(
  ...
  roundedRect(context, padding, padding, width - padding * 2, height - padding * 2, isLandscape ? 32 * unit : 48 * unit);
  context.stroke();
}

`;

let part1 = code.slice(0, code.indexOf(backgroundStartMarker));
let part2 = code.slice(code.indexOf(backgroundEndMarker));

code = part1 + newBackground + part2;
