          ...
          <aside className="advanced-inspector">
            ...
            <section className="inspector-card" id="advanced-trade">
              ...
              <div className="inspector-grid">
                ...
                <label>Trade indicators<select value={settings.tradeIndicatorStyle} onChange={(event) => patchSettings("tradeIndicatorStyle", event.target.value as StudioSettings["tradeIndicatorStyle"])}><option value="detailed">Detailed · BUY $2.9K</option><option value="feed">Feed · animated text</option><option value="markers">Markers · ▲ ▼</option><option value="minimal">Minimal · ●</option></select></label>
