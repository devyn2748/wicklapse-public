...
# For Portrait (starts around line 1251 after previous modifications, look for "const rising = candle.close >= candle.open;")
old_portrait_candles = """    for (const candle of animatedCandles) {
...
new_portrait_candles = """    const style = config.chartStyle ?? "candlestick";
...
# The second occurrence of old_portrait_candles should be in drawPortraitReplayFrame
code = code.replace(old_portrait_candles, new_portrait_candles)
